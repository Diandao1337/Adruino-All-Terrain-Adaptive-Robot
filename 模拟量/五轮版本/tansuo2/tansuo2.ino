...
// #define AFwhee_1    3//后轮引脚1
// #define AFwhee_2    11//后轮引脚2
...
void drive_forward()
{
  ...
  analogWrite(RFwheel_1,120);
  analogWrite(RFwheel_2,0);
  // analogWrite(AFwhee_1,120);
  // analogWrite(AFwhee_2,0);
